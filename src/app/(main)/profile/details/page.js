...
export default function ProfilePage() {
    ...
    return (
        <div className="px-4 py-4 pb-28 space-y-4">
            {/*
              This page is reached from the account menu now, so it needs a way
              back. It used to be /profile itself, with everything on one screen
              and nowhere to return to.
            */}
            <PageHeader title="Profile details" subtitle="Photos, verification, settings and support" />
